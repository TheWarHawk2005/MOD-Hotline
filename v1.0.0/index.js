...
function formatSelection(ele) {
	...
	this.underline = function() {
		let replacedText = this.elementText.substring(0,this.selStart) + `<ins>${this.sel}</ins>` + this.elementText.substring(this.selEnd,this.elementText.length)
		this.element.value = replacedText
	}
	this.strike = function() {
		let replacedText = this.elementText.substring(0,this.selStart) + `<del>${this.sel}</del>` + this.elementText.substring(this.selEnd,this.elementText.length)
		this.element.value = replacedText
	}
